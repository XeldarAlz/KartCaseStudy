...
{
    /// <summary>
    ///     A class representing the fundamental stats required to move the kart.  They are separated in this way in order to
    ///     easily adjust any part of how the kart behaves.
    /// </summary>
    [Serializable]
    public struct KartStats
    {
        [Tooltip(
            "The rate at which the kart increases its forward speed when the accelerate button is held and the brake button isn't held.")]
        ...
        [Tooltip(
            "The rate at which the kart decreases its forward speed when neither the accelerate nor the brake button is held.")]
        ...
        public static void GetModifiedStats(List<IKartModifier> modifiers, KartStats startingStats,
            ref KartStats modifiedStats)
        {
            ...
            for (var i = 0; i < modifiers.Count; i++)
            {
                ...
                modifiedStats.reverseAcceleration =
                    modifiers[i].ModifyReverseAcceleration(modifiedStats.reverseAcceleration);
