...
{
    /// <summary>
    ///     Should be implemented by anything wishing to modify the stats of a kart.  This can be anything from a patch of mud
    ///     on the ground to pickups to the driver of the kart.
