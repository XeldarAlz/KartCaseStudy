...
namespace KartSystem.Track
{
    ...
    public abstract class KartRepositioner : MonoBehaviour
    {
        ...
        ///     This must be overriden by a child class and can perform any operation over any period of time but must call
        ///     RepositionComplete immediately before returning.
        /// </summary>
        ...
        ///     Whether or not the kart is being controlled.  This informs whether control should be
        ///     re-enabled after the reposition.
        /// </param>
