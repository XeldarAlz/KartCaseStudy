...
namespace Michsky.LSS
{
    ...
    public class LSS_LoadingScreen : MonoBehaviour
    {
        ...
        #region Events
        public delegate void LoadingStateDelegate();
        public static event LoadingStateDelegate LoadingStart;
        public static event LoadingStateDelegate LoadingEnd;
        public static event LoadingStateDelegate LoadingDestroy;
